...
/**
 * EmptySea is a class that extends the abstract Ship class It is not a "ship"
 * but helps for playing our simple version of Battleship
 * 
 */
public class EmptySea extends Ship {
	...
	/**
	 * Calls the constructor of the parent class passing the length of this EmptySea
	 * as an argument.
	 */
	// constructor
	public EmptySea() {
	...
	/**
	 * Overrides the Ship.shootAt() method to always return false and sets hit to
	 * true for the "empty" sea.
	 * 
...
//        this.getHit()[0] = true;
	...
	/**
	 * Overrides the Ship.isSunk() method to always return false because an "empty"
	 * sea cannot be sunk.
	 * 
